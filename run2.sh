...
# Optionnel : pour une interface graphique + sortie console
# qemu-system-x86_64 \
#     -bios /usr/share/OVMF/OVMF_CODE_4M.fd \
#     -drive if=pflash,format=raw,file=./OVMF_VARS_4M.fd \
#     -drive format=raw,file=fat.img \
